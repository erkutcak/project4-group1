...
def create_items():
    # Item.query.delete()
    i1= Item(name='Black Velvet Couch', category='Furniture & Decor', price=148.99, description='Black Velvet Couch, great for lounging.', for_sale=True, user_id=1, cart_id=1)
    ...
    i8= Item(name='Soccer Ball', category='Sports & Outdoors', price=19.99, description='Champions League ball, like new!', for_sale=True, user_id=7)
